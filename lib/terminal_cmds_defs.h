...
TERM_CMD_DEF(0x19, PACK_CHECK,                  pack_check)
TERM_CMD_DEF(0x1a, SET_PUMP_MOVING,             set_pump_moving)
...
TERM_CMD_DEF(0x63, STEP_UP,                     step_up)
TERM_CMD_DEF(0x64, STEP_IS_RUNNING,             step_is_running)
